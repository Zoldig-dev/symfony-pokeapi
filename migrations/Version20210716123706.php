 ...
 */
final class Version20210716123706 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pokemon_attack (id INT AUTO_INCREMENT NOT NULL, attack_id INT NOT NULL, pokemon_id INT NOT NULL, level INT NOT NULL, INDEX IDX_2B29516FF5315759 (attack_id), INDEX IDX_2B29516F2FE71C3E (pokemon_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
